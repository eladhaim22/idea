...
public class RankingResource {
    ...
    public RankingResource(ProjectService projectService) {
    ...
    public ResponseEntity GetAll() throws URISyntaxException{
		log.debug("REST request get all qualified projects");	        
		List<RankingDTO> ranking = projectService.GetQualifiedProject();
