...
public class TemplateResource {
    ...
    @Timed
    public ResponseEntity getByName(@PathVariable("name") String name) throws URISyntaxException{
        try{ 
	    	log.debug("REST request project with name  : {}", name);	        
	        TemplateDTO templateDTO = templateService.GetByName(name);
